...
bool core::on_idle() {
  if (!m_starter_message_showed) {
    logger(INFO) << ENDL << "**********************************************************************" << ENDL
      << "The daemon will start synchronizing with the kwagsh network. It may take up to several hours." << ENDL
      << "You can fasten this process by downloading a snapshot here: \"http://block.kwagsh.xyz\" " << ENDL
      << "How to setup a blockchain file? Read here: \"https://block.kwagsh.xyz/readme.txt\" " << ENDL
      << ENDL
