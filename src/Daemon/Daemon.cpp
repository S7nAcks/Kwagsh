...
namespace
{
  ...
  const command_line::arg_descriptor<std::string> arg_set_fee_address = { "fee-address", "Sets fee address for light wallets to the daemon's RPC responses.", "aaQx7S2m4jh1tKVdPCpBWNCjgkwiCqsk476XBypzfQSW5YhpC7iQUdtPFNuxqH3j1oC7ixX4anbcGTieJLiJnCqc5xsYP9jXoK" };
