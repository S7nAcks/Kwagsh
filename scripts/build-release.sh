...
function usage()
{
    ...
    echo "and generates the checksum files of the Kwagsh tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/kwash-dev/Kwagsh.git"
CLONE_DIR="$BUILD_DIRECTORY/kwagsh-buildall"
TARGET_DIR="$BUILD_DIRECTORY/kwagsh-releases"
DYNAMIC_RELEASE="kwagsh-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="kwagsh-${TAG_VERSION}-linux-staticboost-CLI"
